...
import headerImg from "./src/blog-read.png";
...
export const BlogBanner = () => {
  ...
  const toRotate = [ "Welcome To Blog Section !" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                <span className="tagline">HELLO READERS 👋</span>
                <h1> <span className="txt-rotate" dataPeriod="1000" data-rotate='[  "WELCOME TO COMMUNITY !!" ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <button onClick={scrollToBlogs}>Continue Reading <ArrowRightCircle size={25} /></button>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
